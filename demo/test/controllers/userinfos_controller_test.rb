...
class UserinfosControllerTest < ActionController::TestCase
  ...
  test "should create userinfo" do
    assert_difference('Userinfo.count') do
      post :create, userinfo: { age: @userinfo.age, city: @userinfo.city, country: @userinfo.country, user_name: @userinfo.user_name }
    end
  ...
  test "should update userinfo" do
    patch :update, id: @userinfo, userinfo: { age: @userinfo.age, city: @userinfo.city, country: @userinfo.country, user_name: @userinfo.user_name }
    assert_redirected_to userinfo_path(assigns(:userinfo))
  end
